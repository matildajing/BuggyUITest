...
namespace BuggyUITest.Features
{
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("auto_test_", "k_first", "k_last", "1234Qwe!", null)]
        [NUnit.Framework.TestCaseAttribute("!\\”#123_", "k_first", "k_last", "1234Qwe!a", null)]
        [NUnit.Framework.TestCaseAttribute("auto_test_", "k_first_dskfjlskdfjskldfjdsklfjdsklfjdsklfjdsklfjdsklfjdkslfjldsfjdsklfj", "k_last", "1234Qwe!D\"", null)]
        public void RegisterFlowWorkProperly(string login, string firstName, string lastName, string password, string[] exampleTags)
        {
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("auto_test_", "k_first", "k_last", "1234Qwe!", null)]
        public void CancelRegistrationWorkingProperly(string login, string firstName, string lastName, string password, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("login", login);
